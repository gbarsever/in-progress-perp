...
'''If we let Q(new alpha | old alpha) be a random draw from the normal distribution with 
mean = old alpha and standard deviation = .1 * old alpha as they say in that section of the paper and
 P(any alpha) = P(all the current tags | words, that alpha), 
then this gives step-by-step directions for how we do the Metropolis-Hastings update. ''''